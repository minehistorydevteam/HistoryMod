...
public class TileEntityKiln extends TileEntity implements IInventory,ITickable {
	...
	private boolean canSmelt() {
		if(((ItemStack)this.inventory.get(0)).isEmpty() || ((ItemStack)this.inventory.get(1)).isEmpty()) return false;
			...
			ItemStack result = KilnRecipes.getInstance().getSmeltingResult((ItemStack)this.inventory.get(0),(ItemStack)this.inventory.get(1));
	...
	public void smeltItem() {
		if(this.canSmelt()) {
			...
			ItemStack result = KilnRecipes.getInstance().getSmeltingResult(input1,input2);
			ItemStack output=(ItemStack)this.inventory.get(3);
