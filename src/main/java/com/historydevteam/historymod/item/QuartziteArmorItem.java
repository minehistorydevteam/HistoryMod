...
public class QuartziteArmorItem extends ArmorItem {

  public static final IArmorMaterial QUARTZITE_MATERIAL = new IArmorMaterial() {
    @Override
  ...
  public QuartziteArmorItem(EquipmentSlotType equipmentSlotIn) {
    super(QUARTZITE_MATERIAL, equipmentSlotIn, new Properties());
